...
function handleClick_About() {
    const content = `
        ...
        <table class="table-outline">
            <tr>
                <td>PokeRogue created by Sam and many contributors</td>
            </tr>
            <tr>
                <td>Kanto Version created by Futaba</td>
            </tr>
            <tr>
                <td>Offline app created by Admiral Billy</td>
            </tr>
            <tr>
